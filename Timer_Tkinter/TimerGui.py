...
from styleClass import Settings
...
class Main(Settings):
    def __init__(self, root):
        ...
        # widgets
        self.f_clock = tk.Frame(root, bg="white", relief="solid", bd=1, pady=15, padx=30)
    ...
    def configuration_and_grid(self):
        ...
        self.button_start.grid(row=0, column=0, pady=7, padx=(20, 0), ipady=0, ipadx=12)
        self.button_pause.grid(row=0, column=1, padx=(0, 20), ipady=0, ipadx=12)

        self.f_clock.grid(row=1, columnspan=2, pady=(0, 20), padx=20, sticky="nsew")
